...
insert into transaccion (concepto, monto, cuenta_bancaria_id, tipo_trans_id, usuario_id, created_at, updated_at) values ('giro al ecuador', 500.00, 1, 3, 2, '2022-06-30','2022-06-30');
insert into transaccion (concepto, monto, cuenta_bancaria_id, tipo_trans_id, usuario_id, created_at, updated_at) values ('giro al ecuador', 500.00, 1, 2, 2, '2022-06-30','2022-06-30');
insert into transaccion (concepto, monto, cuenta_bancaria_id, tipo_trans_id, usuario_id, created_at, updated_at) values ('giro al ecuador', 500.00, 1, 1, 2, '2022-06-30','2022-06-30');
insert into transaccion (concepto, monto, cuenta_bancaria_id, tipo_trans_id, usuario_id, created_at, updated_at) values ('giro al ecuador', 500.00, 1, 4, 2, '2022-06-30','2022-06-30');
